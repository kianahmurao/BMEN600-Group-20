...
## BMEN600 Project
## Team Name: 20somethings
## Team Members Present: Cinita, Aarushi, Derrick, Kianah

## Candidate Project 1
## Biomedical Problem: Utilizing Apple Watch metrics (physiological signal) to predict sleep cycle phase 

### Possible Research Q: How can we create a model using Apple Watch data on heart rate to predict sleep cycle stage?
